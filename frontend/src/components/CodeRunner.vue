    ...
    <div class="flex justify-between items-center gap-4 px-4 py-3 bg-neutral-800 border-b border-neutral-700">
      ...
      <div class="flex items-center gap-2">
        ...
        <button
          v-if="editable"
          type="button"
          class="inline-flex items-center gap-1.5 px-3 py-2 text-sm font-medium border-none rounded-md transition-all duration-150" :class="[
            editing
        ...
        <button
          type="button"
          :disabled="executing"
          class="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-semibold text-white border-none rounded-md transition-all duration-150"
          :class="[
            executing
